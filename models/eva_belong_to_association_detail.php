<?php
class EvaBelongToAssociationDetail extends EvacakephpAppModel {
	var $name = 'EvaBelongToAssociationDetail';
	...
	var $validate = array(
		...
		'foreignKey' => array(
			'notempty' => array(
				'rule' => array('notempty'),
				'message' => 'foreignKey Cannot Empty',
				//'allowEmpty' => false,
				//'required' => false,
				//'last' => false, // Stop validation after this rule
				//'on' => 'create', // Limit validation to 'create' or 'update' operations
		...
		'eva_belong_to_association_id' => array(
			'notempty' => array(
				'rule' => array('notempty'),
