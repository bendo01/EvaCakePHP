<div id="accordion">
	...
	<?php echo $this->Form->create('EvaHasManyAssociation');?>
		<fieldset>
	 		<legend><?php __('Edit Eva Has Many Association'); ?></legend>
		<?php
	...
	<?php echo $this->Form->end(__('Submit', true));?>
		<div class="actions">
			<ul>
				<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('EvaHasManyAssociation.id')), array('class'=>'list_action_delete_new_data_no_ajax'), sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('EvaHasManyAssociation.id'))); ?></li>
