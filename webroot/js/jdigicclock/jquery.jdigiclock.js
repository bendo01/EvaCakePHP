...
(function($) {
    $.fn.extend({
        ...
        jdigiclock: function(options) {
            ...
            var defaults = {
                clockImagesPath: 'css/jdigiclock/clock/',
                weatherImagesPath: 'css/jdigiclock/weather/',
                lang: 'en',
                am_pm: false,
            ...
            return this.each(function() {
                ...
                html    += '<p id="left_arrow"><img src="css/jdigiclock/images/icon_left.png" /></p>';
                html    += '<p id="right_arrow"><img src="css/jdigiclock/icon_right.png" /></p>';
